                    ...
                    {activeConvId ? (
                        <>
                            ...
                            <form onSubmit={sendAdminMessage} className="p-4 border-t border-gray-100 bg-white flex gap-2">
                                <input value={message} onChange={e => setMessage(e.target.value)} placeholder="Type a message..." className="flex-1 bg-gray-50 border-none rounded-lg px-4 py-2 outline-none focus:ring-1 focus:ring-[var(--color-primary)] text-black" />
